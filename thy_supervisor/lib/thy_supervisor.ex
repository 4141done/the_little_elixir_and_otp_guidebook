defmodule ThySupervisor do
  ...
  def start_link(child_spec_list) do
    # Child specs are basically a list of worker modules and the arugements that should be supplied to their start_link functions
  ...
  defp start_child({mod, fun, args}) do
    case apply(mod, fun, args) do # this calls the function passed in from the child_spec with the specified arguments
      pid when is_pid(pid) ->
        Process.link(pid)
        {:ok, pid}
